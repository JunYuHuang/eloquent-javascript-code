...
The project code is copied and modified from the corresponding code sample on [Eloquent JavaScript](https://eloquentjavascript.net/code/chapter/07_robot.js).
