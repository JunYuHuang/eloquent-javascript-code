...
var Router = /** @class */ (function () {
    ...
    Router.prototype.resolve = function (request, context) {
        return __awaiter(this, void 0, void 0, function () {
            var pathname, _i, _a, _b, method, url, handler, match, parts;
            return __generator(this, function (_c) {
                pathname = new URL(request.url, "http://d").pathname;
                for (_i = 0, _a = this.routes; _i < _a.length; _i++) {
                    _b = _a[_i], method = _b.method, url = _b.url, handler = _b.handler;
                    match = url.exec(pathname);
                    if (!match || request.method != method)
                        continue;
                    parts = match.slice(1).map(decodeURIComponent);
                    return [2 /*return*/, handler.apply(void 0, __spreadArray(__spreadArray([context], parts, false), [request], false))];
                }
                return [2 /*return*/];
            });
        });
